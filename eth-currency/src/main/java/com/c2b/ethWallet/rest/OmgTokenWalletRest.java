...
//@RestController
//@Api("以太坊OMG钱包")
//@RequestMapping("/client/omg")
//public class OmgTokenWalletRest extends BaseRest {
//
...
//  }
//
//  @ApiOperation(value = "创建以太坊omg钱包", notes = "创建以太坊omg钱包")
//  @ApiImplicitParams({ 
...
//    }
//    String address = ethTokenWalletService.createEthTokenWallet(account, Constant.omgTokenName);
//    if (address == null) {
...
//      return writeObj(ErrorMsgEnum.PARAM_ERROR);
//    }
//    String address = ethTokenWalletService.getAddressByAccountAndCurrency(account, Constant.omgTokenName);
...
//    return writeObj(ethTokenWalletService.getTOKENHotWalletBalance(Constant.omgTokenName));
//  }
//
...
//    return writeObj(ethTokenWalletService.getTOKENBalance(address, Constant.omgTokenName));
//  }
//  
...
//    withdrawLog.setCurrency(Constant.omgTokenName);
...
//    String hash = null;
//    try {
//      withdrawLog.setFree(new BigDecimal(0));
