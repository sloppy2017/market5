...
public class HotWalletTool {
  ...
  long userIdHotwallet = -1;
	...
	public String createEtherHotWallet(String passWord) throws Exception{
    	...
    	sysGencodeService.insert(hotWalletAddress);
    	...
    	sysGencodeService.insert(hotWalletPrivateKey);
    	...
    	sysGencodeService.insert(hotWalletType);
    	...
    	sysGencodeService.insert(hotWallethotType);
    	...
    	sysGencodeService.insert(hotWalletUserId);
