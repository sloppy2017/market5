...
public class HttpClient {
    ...
    public static Response post(String url, String data) throws CoralException {
        HttpURLConnection conn = null;
        try {
            URL requestURL = new URL(url);
            byte[] bytes = data.getBytes("utf-8");
            conn = (HttpURLConnection) requestURL.openConnection();
            conn.setRequestProperty("User-Agent", "sanchain-Agent");
            ...
            throw new CoralException("error when sending request, message:" + e.getMessage());
        }finally {
            if(conn != null){
                conn.disconnect();
            }
    ...
    public static Response get(String url) throws CoralException {
        HttpURLConnection conn = null;
        try {
            URL requestURL = new URL(url);
            conn = (HttpURLConnection) requestURL.openConnection();
