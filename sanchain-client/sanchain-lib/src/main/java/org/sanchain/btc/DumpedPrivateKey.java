...
import org.sanchain.btc.account.VersionedChecksummedBytes;
import org.sanchain.core.exception.CoralException;

import java.math.BigInteger;

/**
 * Created by cry on 14-7-2.
 *
...
public class DumpedPrivateKey extends VersionedChecksummedBytes {
     ...
     */
    public DumpedPrivateKey(int ver, String encoded) throws CoralException {
        super(encoded);
        if (version != ver)
            throw new CoralException("Mismatched version number, trying to cross networks? " + version +
                    " vs " + ver);
    }
