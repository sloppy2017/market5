...
public class AccountClientRest extends BaseRest{
	...
	public String tradePairAssetChange(long buyerUserId,String buyerUserName,long sellerUserId,String sellerUserName,String orderNo,
	...
	public AjaxResponse discountPoundage(long buyerUserId,String buyerUserName,long sellerUserId,String sellerUserName,String orderNo,
			int baseCurrencyType,int targetCurrencyType,BigDecimal baseAmount,BigDecimal targetAmount,String remark){
		try {
